...
def cnn_model(name='resnet18', pretrained=True, num_output=NUM_CLASSES):
    if name == 'resnet18':
...
def test():
    net = cnn_model(name='resnet18')

    summary(net, (1, 128, 96))
    #y = net(torch.randn(1, 2, 256, 960))
    print(net)
